...
PREMISSAS.update({
    ...
    'benchmark_cac_min': 100,       # R$ 100 – limite inferior saudável
    ...
    'growth_m1_6_otimista': 0.20,
    'growth_m7_12_otimista': 0.15,
    'growth_m13_36_otimista': 0.08,
