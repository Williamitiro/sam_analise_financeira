...
PREMISSAS = {
    ...
    # 2. TAXAS DE GROWTH POR TIER (aumentadas)
    'growth_tiers': [
        {'budget_min': 0,     'budget_max': 1000,  'taxa': 0.01},  # 1% (hustle)
        {'budget_min': 1000,  'budget_max': 2000,  'taxa': 0.03},  # 3%
        {'budget_min': 2000,  'budget_max': 4000,  'taxa': 0.04},  # 4% ⬆️
        {'budget_min': 4000,  'budget_max': 8000,  'taxa': 0.05},  # 5% ⬆️
        {'budget_min': 8000,  'budget_max': 20000, 'taxa': 0.055},  # 5.5% ⬆️
        {'budget_min': 20000, 'budget_max': 999999,'taxa': 0.065},  # 6.5% ⬆️
    ],
    ...
    'taxa_trial_para_pagante': 0.13,         # Ajustado de 12% para 16%
    ...
    'fator_visitas_organicas_por_pagante': 1.2,  # 1,2
    ...
    # ========================================================================
    'churn_inicial': 0.12,
    'churn_maturidade': 0.055,                # Ajustado de 6% para 5%
    'churn_base': 0.07,
    'churn_decaimento_mensal': 0.002,        # Ajustado de 0.002
    ...
    'marketing_perc_receita': 0.40,          # Ajustado de 40% para 25%
    ...
    # Mix de Canais
    'canal_instagram_pct': 0.40, 'cpc_instagram': 1.40, 'conv_instagram': 0.03,
    'canal_facebook_pct': 0.30,  'cpc_facebook': 0.90,  'conv_facebook': 0.02,
    'canal_youtube_pct': 0.20,   'cpc_youtube': 3.50,   'conv_youtube': 0.09,
    'canal_google_pct': 0.10,    'cpc_google': 7.00,    'conv_google': 0.12,
    ...
    # ========================================================================
    'salario_fundador': 2500.00,    'trigger_fundador': 20000.00,  # Ajustado de 45k
    'salario_dev_senior': 10000.00, 'trigger_dev': 700,            # Ajustado de 700
    'salario_cs': 4500.00,          'trigger_cs': 800,             # Ajustado de 800
    ...
    # ========================================================================
    'caixa_inicial': 4000.00,              # Ajustado de R$ 2k para R$ 5k
    'aporte_mensal': 2500.00,              # 
    'meses_aporte': 6,
