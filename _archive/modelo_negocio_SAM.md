...
|                                                      |                                   |                                                                 |               |                 |
| **Custos Operacionais Mensais (Fase 1)**             | VPS Principal (Hostinger KVM 4)   | Hospedagem do backend (DB, API, Workers).                       | **Opex**      | R$ 55,00        |
|                                                      | VPS Coleta de Dados (AWS Windows) | Servidor dedicado para rodar o terminal MT5 24/7.               | **Opex**      | R$ 150,00       |
|                                                      | Ferramentas de Dev (IA, etc.)     | GitHub Copilot, Cursor IDE. Aceleradores de produtividade.      | **Opex**      | R$ 300,00       |
...
|                                                      | **SUBTOTAL OPEX MENSAL (Fase 1)** | **Custo recorrente para operar, sem salários.**                 |               | **R$ 1.709,00** |
|                                                      |                                   |                                                                 |               |                 |
| **CUSTO TOTAL PARA INICIAR E OPERAR O PRIMEIRO MÊS** | (Total Capex + 1º Mês de Opex)    | **Capital necessário para comprar os ativos e pagar o 1º mês.** |               | **R$ 9.709,00** |
