...
"""
00_Dashboard_Principal.py
Dashboard Principal do SAM Financial Model
Versão 4.0 - UI/UX Profissional com Insights Automáticos

Features:
- KPIs destacados com mini sparklines
...
if st.session_state.df_projecao is None or st.session_state.kpis is None:
    st.info("👈 Clique em **Executar Projeção** na barra lateral para começar")
    st.stop()
